...
public class ConsoleService {
    ...
    private IOConsoleOutputStream warningStream;
    private IOConsoleOutputStream infoStream;
    private IOConsoleOutputStream generalStream;
    ...
    public void writeWarning(String message) {
        String output = getTimeString() + " WARNING: " + message + ENTER;
        switch (PreferencesHelper.getConsolePopupLevel()) {
        case ALL:
            popConsoleView();
            break;
    ...
    private void writeToConsole(IOConsoleOutputStream stream, String output) {
        try {
            ...
            OPIBuilderPlugin.getLogger().log(Level.WARNING, "Write Console error", e);
        }
    }
    ...
    private void popConsoleView() {
        if (PlatformUI.getWorkbench() != null &&
                ...
                PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage()
                        .findView("org.eclipse.ui.console.ConsoleView") == null) {
            UIBundlingThread.getInstance().addRunnable(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        OPIBuilderPlugin.getLogger().log(Level.WARNING, "ConsoleView activation error", e);
                    }
                }
            });
        }
