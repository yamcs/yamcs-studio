...
import org.csstudio.utility.file.LinkedResourcesJob;
...
/**
 * Run OPI from external program, such as alarm GUI, data browser... Extra data may be provided to provide macros and
 * update shared links before opening the OPI.
 * 
 * @author Xihui Chen
 * @author Kay Kasemir
 * @author Will Rogers
...
public class ExternalOpenDisplayAction implements IOpenDisplayAction {
     ...
     * 
     * @param path
     *            the path of the OPI file, it can be a workspace path, file system path, URL or a opi file in opi
     *            search path.
     * @param data
     *            the input macros and shared links in format of
