...
public class LogConfigurator {
     ...
     * 
     * @throws Exception
     *             on error: Invalid preference values, errors during logger setup
     */
    public static void configureFromPreferences() throws Exception {
        ...
        if (ilog_listener == null) { // .. but only once
    ...
    /**
     * Configure all currently active loggers. Ordinarily, that should be the root logger writing to the console, but
     * additional handlers could already be in place via "lib/logging.properties" in the JRE directory or other means.
     * 
     * @param level
     * @param formatter
     */
    ...
    /**
     * Configure a file logger When logging to multiple files, the first one will use the given filename. When that file
     * is full, it's renamed to filename.1, and a new filename.0 is written.
     * 
     * @param level
     *            Log level to use with file logging. <code>Level.OFF</code> to disable file logging
     * @param file_pattern
     *            Base name of the file, ".0", ".1", ".2" will be added for multiple files
     * @param max_bytes
     *            When file exceeds this size, a new file will be created
     * @param max_files
     *            Number of files to use
     * @throws Exception
     *             on error: Cannot create new file, ...
     */
