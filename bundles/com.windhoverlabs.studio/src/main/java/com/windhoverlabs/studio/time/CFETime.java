...
public class CFETime {
    ...
    */
    ...
    /**
     * Return relative since the Epoch. In java this is the Unix Epoch: 1970-01-01T00:00:00Z. Very useful for
     * representing CFE relative time such as MET time.
     * 
     * @param seconds
     * @param subSeconds
     * @return
    ...
    /**
     * Return relative since the Epoch provided. Very useful for representing times like GPS time.
     * 
     * @param seconds
     * @param subSeconds
     * @return
     * @note Please note the use of Java.Instant here. This is the modern approach of handling time in the JVM.
     */
    public static Instant getTimeSinceEpoch(long seconds, long subSeconds, long epochYear, long epochDay,
            long epochHour, long epochMinute, long epochSecond) {
        long subMicroSecs = CFE_TIME_Sub2MicroSecs(subSeconds);
    ...
    /**
     * Return relative since the CFS EPOCH. At the time of writing the CFS Epoch is described as the following:
     * CFE_TIME_EPOCH_YEAR: 1980 CFE_TIME_EPOCH_DAY: 1 CFE_TIME_EPOCH_HOUR 0 CFE_TIME_EPOCH_MINUTE:0
    ...
    public static Instant getTimeSinceCFSEpoch(long seconds, long subSeconds) {
        return getTimeSinceEpoch(seconds, subSeconds, CFE_TIME_EPOCH_YEAR, CFE_TIME_EPOCH_DAY, CFE_TIME_EPOCH_HOUR,
                CFE_TIME_EPOCH_MINUTE, CFE_TIME_EPOCH_SECOND);
    }
