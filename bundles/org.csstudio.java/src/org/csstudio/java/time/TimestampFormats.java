 ...
 *
 * <p>
 * Java 8 introduced {@link Instant} which handles time stamps with up to nanosecond detail, obsoleting custom classes
 ...
 *
 * <p>
 * The formatters defined here are suggested for CS-Studio time stamps because they can show the full detail of control
 * system time stamps in a portable way, independent from locale.
 *
 * @author Kay Kasemir
 */
public class TimestampFormats {
     ...
     *
     * <p>
     * If the time stamp falls within today, only hours .. seconds are displayed. For a time stamp on a different day
     * from today, the date and time without seconds shown. For a time in different year, only the date is shown.
     *
     * @param timestamp
     *            {@link Instant}
