...
public abstract class AbstractScale extends Figure {
    ...
    public enum LabelSide {
        ...
        /**
         * top or right side of tick marks for linear scale, or inside for round scale
         */
        Secondary
    }
    ...
    /**
     * Whenever any parameter has been changed, the scale should be marked as dirty, so all the inner parameters could
     * be recalculated before the next paint
     */
     ...
     * 
     * @param timeUnit
     *            the timeUnit to set. It should be one of: <tt>Calendar.MILLISECOND</tt>, <tt>Calendar.SECOND</tt>,
     *            <tt>Calendar.MINUTE</tt>, <tt>Calendar.HOUR_OF_DAY</tt>, <tt>Calendar.DATE</tt>,
     *            <tt>Calendar.MONTH</tt>, <tt>Calendar.YEAR</tt>.
     * @see Calendar
     */
