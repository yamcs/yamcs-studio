...
public class XYGraphToolbar extends Figure {
    ...
    public XYGraphToolbar(final XYGraph xyGraph, final int flags) {
        ...
        if (Preferences.isCombineLabelsAndTraces()) {
            final ToggleButton valueLabelsButton = new ToggleButton(
                    new ImageFigure(XYGraphMediaFactory.getInstance().getImage("images/HoverLabels.png")));
            ...
            final ToggleButton axisTraceButton = new ToggleButton(
