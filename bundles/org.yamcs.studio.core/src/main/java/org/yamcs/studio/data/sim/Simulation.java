...
/**
 * Base class for all simulated signals. It provides the common mechanism for registering the update on a timer and a
 * few other utilities.
 */
public abstract class Simulation<T> {
     ...
     */
    public abstract List<VType> createValues(TimeInterval interval);
