...
public class Executors {
    ...
    /**
     * A thread factory where each new thread starts with the given name. The name of the thread will be poolname +
     * number. This can be used instead of {@link java.util.concurrent.Executors#defaultThreadFactory()}, which
     * unfortunately only use generic names for the thread, which makes it harder to debug.
     *
     * @param poolName
     *            name of the pool
