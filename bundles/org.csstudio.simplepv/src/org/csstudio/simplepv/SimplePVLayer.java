...
/**
 * The entry point of simplepv layer. Clients should use this entry to get the PV factory to create PVs.
 * 
 * @author Xihui Chen
 *
 */
public class SimplePVLayer {
    ...
    private static final String EXTPOINT_PVFACTORY = "org.csstudio.simplepv.pvfactory";

    private static Map<String, AbstractPVFactory> factoryMap = new HashMap<>(4);

    /**
     * If there is only one {@link AbstractPVFactory} implementation, return it. If there are multiple implementations,
     * return the default PV factory which is configured in the preference.
     * 
     * @return Default PV Factory or null if not exist.
     * @throws CoreException
     *             on loading extensions error.
     */
     ...
     * 
     * @param pvFactoryId
     *            ID of the PV Factory extension.
