...
import org.csstudio.opibuilder.properties.support.ProcedurePropertyDescriptor;
...
public class ProcedureProperty extends StringProperty {
    ...
    /**
     * Procedure Property Constructor. The property value type is {@link String}.
     *
     * @param prop_id
    ...
    protected PropertyDescriptor createPropertyDescriptor() {
        return new ProcedurePropertyDescriptor(prop_id, description, detailDescription);
    }
}
