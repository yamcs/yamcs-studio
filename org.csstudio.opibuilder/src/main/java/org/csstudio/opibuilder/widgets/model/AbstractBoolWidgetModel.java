...
public abstract class AbstractBoolWidgetModel extends AbstractPVWidgetModel {
    ...
    public static final String PROP_ON_LABEL = "on_label";

    /** Label text when boolean widget is off. */
    public static final String PROP_OFF_LABEL = "off_label";
    ...
    public static final String PROP_SHOW_BOOL_LABEL = "show_boolean_label";

    public static final String PROP_BOOL_LABEL_POS = "boolean_label_position";

    /**
     * Data type to be operated by this widget, could be Bit or Enum. If it is Bit, the widget will write 0/1 to the
     * corresponding bit of the PV. If it is ENUM, it will write On State/Off State property value to the PV.
     */
     ...
     */
    public static final String PROP_ON_STATE = "on_state";

    /**
     * If data type is Enum, it is the string value which will be written to the PV when widget is off.
     */
    public static final String PROP_OFF_STATE = "off_state";
