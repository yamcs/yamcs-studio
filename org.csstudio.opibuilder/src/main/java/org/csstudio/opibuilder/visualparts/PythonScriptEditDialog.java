 ...
 */
public class PythonScriptEditDialog extends Dialog {

    private String title;
    private String contents;
    private TMViewer text;

    protected PythonScriptEditDialog(Shell parentShell, String stringValue, String dialogTitle) {
        super(parentShell);
        title = dialogTitle;
