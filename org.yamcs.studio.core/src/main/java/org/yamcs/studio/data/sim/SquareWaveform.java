...
public class SquareWaveform extends SimFunction<VDoubleArray> {
    ...
    /**
     * Creates a square wave of 100 samples, with given period and given wavelength of 100 samples, updating at given
     * rate.
     *
    ...
    /**
     * Creates a square wave of 100 samples, with given period and given wavelength of given number of samples, updating
     * at given rate.
     *
     * @param periodInSeconds
     *            the period measured in seconds
     ...
     *            the update rate in seconds
     */
    public SquareWaveform(Double periodInSeconds, Double wavelengthInSamples, Double nSamples,
