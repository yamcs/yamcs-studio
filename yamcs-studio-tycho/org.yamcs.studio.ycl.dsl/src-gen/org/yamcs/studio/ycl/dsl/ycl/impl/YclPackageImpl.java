...
import org.yamcs.studio.ycl.dsl.ycl.ArgumentAssignment;
import org.yamcs.studio.ycl.dsl.ycl.Command;
import org.yamcs.studio.ycl.dsl.ycl.CommandId;
import org.yamcs.studio.ycl.dsl.ycl.Model;
import org.yamcs.studio.ycl.dsl.ycl.YclFactory;
import org.yamcs.studio.ycl.dsl.ycl.YclPackage;
 ...
 * @generated
 */
public class YclPackageImpl extends EPackageImpl implements YclPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass argumentAssignmentEClass = null;
   ...
   * @see org.yamcs.studio.ycl.dsl.ycl.YclPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private YclPackageImpl()
  {
    super(eNS_URI, YclFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link YclPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static YclPackage init()
  {
    if (isInited) return (YclPackage)EPackage.Registry.INSTANCE.getEPackage(YclPackage.eNS_URI);

    // Obtain or create and register package
    YclPackageImpl theYclPackage = (YclPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof YclPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new YclPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theYclPackage.createPackageContents();

    // Initialize created meta-data
    theYclPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theYclPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(YclPackage.eNS_URI, theYclPackage);
    return theYclPackage;
  }
   ...
   * @generated
   */
  public EClass getArgumentAssignment()
  {
    return argumentAssignmentEClass;
  }
   ...
   * @generated
   */
  public EAttribute getArgumentAssignment_Name()
  {
    return (EAttribute)argumentAssignmentEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getArgumentAssignment_Value()
  {
    return (EAttribute)argumentAssignmentEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public YclFactory getYclFactory()
  {
    return (YclFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(argumentAssignmentEClass, ARGUMENT_ASSIGNMENT__VALUE);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getArgumentAssignment_Value(), ecorePackage.getEString(), "value", null, 0, 1, ArgumentAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
