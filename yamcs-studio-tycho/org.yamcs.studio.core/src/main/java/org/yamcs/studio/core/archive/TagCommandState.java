 ...
 * the tag button in the ArchiveView toolbar.
 */
public class TagCommandState extends AbstractSourceProvider {

    public static final String STATE_KEY_ENABLED = "org.yamcs.studio.core.archive.state.tagEnabled";
