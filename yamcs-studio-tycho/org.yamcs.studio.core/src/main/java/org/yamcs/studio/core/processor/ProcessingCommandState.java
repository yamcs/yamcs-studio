...
public class ProcessingCommandState extends AbstractSourceProvider {
    ...
    public static final String STATE_KEY_REPLAY = "org.yamcs.studio.core.processor.state.replay";
    public static final String STATE_KEY_PROCESSING = "org.yamcs.studio.core.processor.state.processing";
